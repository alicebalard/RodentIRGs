...
# for F in /SAN/Alices_sandpit/Torelli_transcriptomics/big_data/genomes/*.fna; do tblastn -query /SAN/Alices_sandpit/Torelli_transcriptomics/GIT/RodentIRGs/data/fasta/Protein_sequences_of_IRG_mouse_GRCm39.fasta -db $F -num_threads 16 -outfmt "6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore sseq" -out /SAN/Alices_sandpit/Torelli_transcriptomics/GIT/RodentIRGs/data/blast_results/IRGmus2otherRodents/tblastnIRGmusGRCm39_vs_$(basename -- "$F").outfmt6; done
